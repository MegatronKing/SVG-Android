...
[![Jcenter Status](https://img.shields.io/badge/download-1.3.1-brightgreen.svg)](http://jcenter.bintray.com/com/github/megatronking)
...
buildscript {
    ...
    dependencies {
        classpath 'com.github.megatronking:svg-plugin:1.3.1'
    }
}
