 ...
 */
public class ic_line_style extends SVGRenderer {

    public ic_line_style(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.close();
        mPath.moveTo(3.0f, 16.0f);
        mPath.rMoveTo(6.5f, 0.0f);
        mPath.rLineTo(5.0f, 0f);
        mPath.rLineTo(0f, -2.0f);
        mPath.rLineTo(-5.0f, 0f);
        mPath.rLineTo(0f, 2.0f);
        mPath.close();
        mPath.moveTo(9.5f, 16.0f);
        mPath.rMoveTo(6.5f, 0.0f);
        mPath.rLineTo(5.0f, 0f);
        mPath.rLineTo(0f, -2.0f);
        mPath.rLineTo(-5.0f, 0f);
