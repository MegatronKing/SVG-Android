 ...
 */
public class ic_all_out extends SVGRenderer {

    public ic_all_out(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rMoveTo(-12.0f, 4.0f);
        mPath.rLineTo(-4.0f, -4.0f);
        mPath.rLineTo(0f, 4.0f);
        mPath.close();
        mPath.moveTo(8.209999f, 20.16f);
        mPath.rMoveTo(-4.0f, -12.0f);
        mPath.rLineTo(4.0f, -4.0f);
        mPath.rLineTo(-4.0f, 0f);
        mPath.close();
        mPath.moveTo(4.209999f, 8.16f);
        mPath.rMoveTo(12.95f, -0.95f);
