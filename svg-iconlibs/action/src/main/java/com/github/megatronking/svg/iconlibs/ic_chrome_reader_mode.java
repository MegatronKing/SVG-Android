 ...
 */
public class ic_chrome_reader_mode extends SVGRenderer {

    public ic_chrome_reader_mode(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rLineTo(7.0f, 0f);
        mPath.lineTo(20.0f, 11.0f);
        mPath.rLineTo(-7.0f, 0f);
        mPath.close();
        mPath.moveTo(13.0f, 9.5f);
        mPath.rMoveTo(0.0f, 5.0f);
        mPath.rLineTo(7.0f, 0f);
        mPath.lineTo(20.0f, 16.0f);
        mPath.rLineTo(-7.0f, 0f);
        mPath.close();
        mPath.moveTo(13.0f, 14.5f);
