 ...
 */
public class ic_settings_cell extends SVGRenderer {

    public ic_settings_cell(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.moveTo(16.0f, 0.01f);
        mPath.lineTo(8.0f, 0.0f);
        mPath.cubicTo(6.9f, 0.0f, 6.0f, 0.9f, 6.0f, 2.0f);
