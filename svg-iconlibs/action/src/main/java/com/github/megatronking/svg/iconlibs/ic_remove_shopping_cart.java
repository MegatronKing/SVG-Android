 ...
 */
public class ic_remove_shopping_cart extends SVGRenderer {

    public ic_remove_shopping_cart(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.moveTo(22.73f, 22.73f);
        mPath.lineTo(2.77f, 2.77f);
        mPath.lineTo(2.0f, 2.0f);
        mPath.rLineTo(-0.73f, -0.73f);
        mPath.lineTo(0.0f, 2.54f);
        mPath.rLineTo(4.39f, 4.39f);
        mPath.rLineTo(2.21f, 4.66f);
        ...
        mPath.rLineTo(1.38f, 1.38f);
        mPath.rCubicTo(-0.5f, 0.36f, -0.83f, 0.95f, -0.83f, 1.62f);
        mPath.rCubicTo(0.0f, 1.1f, 0.89f, 2.0f, 1.99f, 2.0f);
        mPath.rCubicTo(0.67f, 0.0f, 1.26f, -0.33f, 1.62f, -0.84f);
        mPath.lineTo(21.46f, 24.0f);
        mPath.rLineTo(1.27f, -1.27f);
        mPath.close();
        mPath.moveTo(22.73f, 22.73f);
        mPath.moveTo(7.42f, 15.0f);
        mPath.rCubicTo(-0.14f, 0.0f, -0.25f, -0.11f, -0.25f, -0.25f);
        mPath.rLineTo(0.03f, -0.12f);
        mPath.rLineTo(0.9f, -1.63f);
        mPath.rLineTo(2.36f, 0f);
        mPath.rLineTo(2.0f, 2.0f);
        mPath.lineTo(7.42f, 15.0f);
        mPath.close();
        mPath.moveTo(7.42f, 15.0f);
        mPath.rMoveTo(8.13f, -2.0f);
        ...
        mPath.lineTo(6.54f, 4.0000005f);
        mPath.rLineTo(9.01f, 9.0f);
        mPath.close();
        mPath.moveTo(15.55f, 13.0f);
