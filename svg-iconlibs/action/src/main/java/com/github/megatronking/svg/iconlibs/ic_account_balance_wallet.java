 ...
 */
public class ic_account_balance_wallet extends SVGRenderer {

    public ic_account_balance_wallet(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
