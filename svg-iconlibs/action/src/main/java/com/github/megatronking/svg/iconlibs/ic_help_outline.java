 ...
 */
public class ic_help_outline extends SVGRenderer {

    public ic_help_outline(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rCubicTo(0.0f, 2.0f, -3.0f, 1.75f, -3.0f, 5.0f);
        mPath.rLineTo(2.0f, 0f);
        mPath.rCubicTo(0.0f, -2.25f, 3.0f, -2.5f, 3.0f, -5.0f);
