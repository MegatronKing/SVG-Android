 ...
 */
public class ic_lock_outline extends SVGRenderer {

    public ic_lock_outline(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rLineTo(0f, 2.0f);
        mPath.lineTo(8.9f, 8.0f);
        mPath.lineTo(8.9f, 6.0f);
        mPath.close();
        mPath.moveTo(8.9f, 6.0f);
        mPath.moveTo(18.0f, 20.0f);
