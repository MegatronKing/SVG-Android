 ...
 */
public class ic_swap_vertical_circle extends SVGRenderer {

    public ic_swap_vertical_circle(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.close();
        mPath.moveTo(12.0f, 2.0f);
        mPath.moveTo(6.5f, 9.0f);
        mPath.lineTo(10.0f, 5.5f);
        mPath.lineTo(13.5f, 9.0f);
        ...
        mPath.close();
        mPath.moveTo(6.5f, 9.0f);
        mPath.rMoveTo(11.0f, 6.0f);
        mPath.lineTo(14.0f, 18.5f);
        mPath.lineTo(10.5f, 15.0f);
