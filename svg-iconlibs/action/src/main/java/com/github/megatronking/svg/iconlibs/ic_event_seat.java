 ...
 */
public class ic_event_seat extends SVGRenderer {

    public ic_event_seat(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.close();
        mPath.moveTo(4.0f, 18.0f);
        mPath.rMoveTo(15.0f, -8.0f);
        mPath.rLineTo(3.0f, 0f);
        mPath.rLineTo(0f, 3.0f);
        mPath.rLineTo(-3.0f, 0f);
        mPath.close();
        mPath.moveTo(19.0f, 10.0f);
        mPath.moveTo(2.0f, 10.0f);
        mPath.rLineTo(3.0f, 0f);
        mPath.rLineTo(0f, 3.0f);
        mPath.lineTo(2.0f, 13.0f);
        mPath.close();
        mPath.moveTo(2.0f, 10.0f);
        mPath.rMoveTo(15.0f, 3.0f);
