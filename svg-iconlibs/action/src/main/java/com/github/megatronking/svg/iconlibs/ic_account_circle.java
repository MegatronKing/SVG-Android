 ...
 */
public class ic_account_circle extends SVGRenderer {

    public ic_account_circle(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rMoveTo(0.0f, 14.2f);
        mPath.rCubicTo(-2.5f, 0.0f, -4.71f, -1.28f, -6.0f, -3.22f);
        mPath.rCubicTo(0.03f, -1.99f, 4.0f, -3.08f, 6.0f, -3.08f);
        mPath.rCubicTo(1.99f, 0.0f, 5.97f, 1.09f, 6.0f, 3.08f);
        mPath.rCubicTo(-1.29f, 1.94f, -3.5f, 3.22f, -6.0f, 3.22f);
        mPath.close();
        mPath.moveTo(12.0f, 19.2f);
