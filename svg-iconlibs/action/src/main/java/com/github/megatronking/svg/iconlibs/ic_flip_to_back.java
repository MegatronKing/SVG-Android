 ...
 */
public class ic_flip_to_back extends SVGRenderer {

    public ic_flip_to_back(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
