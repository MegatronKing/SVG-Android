 ...
 */
public class ic_perm_device_information extends SVGRenderer {

    public ic_perm_device_information(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
