 ...
 */
public class ic_tab_unselected extends SVGRenderer {

    public ic_tab_unselected(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
