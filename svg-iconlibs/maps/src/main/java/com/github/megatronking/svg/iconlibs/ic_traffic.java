 ...
 */
public class ic_traffic extends SVGRenderer {

    public ic_traffic(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.moveTo(20.0f, 10.0f);
        mPath.rLineTo(-3.0f, 0f);
        mPath.lineTo(17.0f, 8.86f);
        mPath.rCubicTo(1.72f, -0.45f, 3.0f, -2.0f, 3.0f, -3.86f);
        mPath.rLineTo(-3.0f, 0f);
