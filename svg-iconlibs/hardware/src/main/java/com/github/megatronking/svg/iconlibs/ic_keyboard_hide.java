 ...
 */
public class ic_keyboard_hide extends SVGRenderer {

    public ic_keyboard_hide(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.close();
        mPath.moveTo(8.0f, 9.0f);
        mPath.rMoveTo(-1.0f, 2.0f);
        ...
        mPath.rMoveTo(-7.0f, 15.0f);
        mPath.rLineTo(4.0f, -4.0f);
        mPath.lineTo(8.0f, 19.0f);
        mPath.rLineTo(4.0f, 4.0f);
        mPath.close();
        mPath.moveTo(12.0f, 23.0f);
