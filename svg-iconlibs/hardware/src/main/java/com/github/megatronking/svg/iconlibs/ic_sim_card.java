 ...
 */
public class ic_sim_card extends SVGRenderer {

    public ic_sim_card(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rLineTo(12.01f, 0f);
        mPath.rCubicTo(1.1f, 0.0f, 1.99f, -0.9f, 1.99f, -2.0f);
        mPath.rLineTo(-0.01f, -16.0f);
        mPath.close();
        mPath.moveTo(19.99f, 4.0f);
