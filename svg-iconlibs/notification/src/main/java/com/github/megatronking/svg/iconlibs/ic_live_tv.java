 ...
 */
public class ic_live_tv extends SVGRenderer {

    public ic_live_tv(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rLineTo(-7.59f, 0f);
        mPath.rLineTo(3.29f, -3.29f);
        mPath.lineTo(16.0f, 2.0f);
        mPath.rLineTo(-4.0f, 4.0f);
        mPath.rLineTo(-4.0f, -4.0f);
        mPath.rLineTo(-0.71f, 0.71f);
        mPath.lineTo(10.59f, 6.0f);
        ...
        mPath.lineTo(3.0f, 8.0f);
        mPath.rLineTo(18.0f, 0f);
        mPath.rLineTo(0f, 12.0f);
        mPath.close();
        mPath.moveTo(21.0f, 20.0f);
        mPath.moveTo(9.0f, 10.0f);
        mPath.rLineTo(0f, 8.0f);
        mPath.rLineTo(7.0f, -4.0f);
        mPath.close();
        mPath.moveTo(9.0f, 10.0f);
