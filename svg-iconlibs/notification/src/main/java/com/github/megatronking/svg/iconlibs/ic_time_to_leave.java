 ...
 */
public class ic_time_to_leave extends SVGRenderer {

    public ic_time_to_leave(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.moveTo(18.92f, 5.01f);
        mPath.cubicTo(18.72f, 4.42f, 18.16f, 4.0f, 17.5f, 4.0f);
        ...
        mPath.close();
        mPath.moveTo(18.92f, 5.01f);
        mPath.moveTo(6.5f, 15.0f);
        mPath.rCubicTo(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        mPath.cubicTo(5.0f, 12.67f, 5.67f, 12.0f, 6.5f, 12.0f);
        mPath.rCubicTo(0.8299999f, 0.0f, 1.5f, 0.67f, 1.5f, 1.5f);
        mPath.cubicTo(8.0f, 14.33f, 7.33f, 15.0f, 6.5f, 15.0f);
        mPath.close();
        mPath.moveTo(6.5f, 15.0f);
