 ...
 */
public class ic_airline_seat_legroom_normal extends SVGRenderer {

    public ic_airline_seat_legroom_normal(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.close();
        mPath.moveTo(5.0f, 12.0f);
        mPath.rMoveTo(15.5f, 6.0f);
        mPath.lineTo(19.0f, 18.0f);
        ...
        mPath.rCubicTo(0.0f, 1.65f, 1.35f, 3.0f, 3.0f, 3.0f);
