 ...
 */
public class ic_event_busy extends SVGRenderer {

    public ic_event_busy(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.moveTo(9.31f, 17.0f);
        mPath.rLineTo(2.44f, -2.44f);
        mPath.lineTo(14.19f, 17.0f);
        mPath.rLineTo(1.06f, -1.06f);
        mPath.rLineTo(-2.44f, -2.44f);
        mPath.rLineTo(2.44f, -2.44f);
        mPath.lineTo(14.19f, 10.0f);
        mPath.rLineTo(-2.44f, 2.44f);
        mPath.lineTo(9.31f, 10.0f);
        mPath.rLineTo(-1.06f, 1.06f);
        mPath.rLineTo(2.44f, 2.44f);
        mPath.rLineTo(-2.44f, 2.44f);
        mPath.lineTo(9.31f, 17.0f);
        mPath.close();
        mPath.moveTo(9.31f, 17.0f);
