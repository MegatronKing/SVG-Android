 ...
 */
public class ic_dialer_sip extends SVGRenderer {

    public ic_dialer_sip(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
