 ...
 */
public class ic_present_to_all extends SVGRenderer {

    public ic_present_to_all(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.close();
        mPath.moveTo(21.0f, 3.0f);
        mPath.rMoveTo(0.0f, 16.02f);
        mPath.lineTo(3.0f, 19.02f);
        mPath.lineTo(3.0f, 4.98f);
        mPath.rLineTo(18.0f, 0f);
        mPath.rLineTo(0f, 14.04f);
        mPath.close();
