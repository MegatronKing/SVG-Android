 ...
 */
public class ic_business extends SVGRenderer {

    public ic_business(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
