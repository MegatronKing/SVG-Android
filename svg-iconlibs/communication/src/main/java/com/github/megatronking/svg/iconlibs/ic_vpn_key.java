 ...
 */
public class ic_vpn_key extends SVGRenderer {

    public ic_vpn_key(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.moveTo(12.65f, 10.0f);
        mPath.cubicTo(11.83f, 7.67f, 9.61f, 6.0f, 7.0f, 6.0f);
        mPath.rCubicTo(-3.31f, 0.0f, -6.0f, 2.69f, -6.0f, 6.0f);
        mPath.rCubicTo(0.0f, 3.3099995f, 2.69f, 6.0f, 6.0f, 6.0f);
        mPath.rCubicTo(2.61f, 0.0f, 4.83f, -1.67f, 5.65f, -4.0f);
