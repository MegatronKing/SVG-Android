 ...
 */
public class ic_kitchen extends SVGRenderer {

    public ic_kitchen(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rCubicTo(0.0f, -1.11f, -0.9f, -1.99f, -2.0f, -1.99f);
        mPath.close();
        mPath.moveTo(18.0f, 2.01f);
        mPath.moveTo(18.0f, 20.0f);
        mPath.lineTo(6.0f, 20.0f);
        mPath.rLineTo(0f, -9.02f);
        mPath.rLineTo(12.0f, 0f);
        mPath.lineTo(18.0f, 20.0f);
        mPath.close();
        mPath.moveTo(18.0f, 20.0f);
        mPath.rMoveTo(0.0f, -11.0f);
