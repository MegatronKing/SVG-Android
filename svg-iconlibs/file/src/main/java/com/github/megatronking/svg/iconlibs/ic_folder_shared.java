 ...
 */
public class ic_folder_shared extends SVGRenderer {

    public ic_folder_shared(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rCubicTo(0.0f, -1.33f, 2.67f, -2.0f, 4.0f, -2.0f);
        mPath.rCubicTo(1.3299999f, 0.0f, 4.0f, 0.67f, 4.0f, 2.0f);
        mPath.rLineTo(0f, 1.0f);
        mPath.close();
