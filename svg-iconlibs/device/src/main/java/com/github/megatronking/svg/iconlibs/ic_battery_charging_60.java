 ...
 */
public class ic_battery_charging_60 extends SVGRenderer {

    public ic_battery_charging_60(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rLineTo(1.87f, -3.5f);
        mPath.lineTo(7.0f, 11.0f);
        mPath.rLineTo(0f, 9.67f);
