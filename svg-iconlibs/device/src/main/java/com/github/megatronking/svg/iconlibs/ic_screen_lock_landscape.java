 ...
 */
public class ic_screen_lock_landscape extends SVGRenderer {

    public ic_screen_lock_landscape(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
