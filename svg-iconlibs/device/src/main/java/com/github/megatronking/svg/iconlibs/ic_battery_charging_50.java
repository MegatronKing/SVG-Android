 ...
 */
public class ic_battery_charging_50 extends SVGRenderer {

    public ic_battery_charging_50(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.moveTo(14.47f, 13.5f);
        mPath.lineTo(11.0f, 20.0f);
        mPath.rLineTo(0f, -5.5f);
        mPath.lineTo(9.0f, 14.5f);
        mPath.rLineTo(0.53f, -1.0f);
        mPath.lineTo(7.0f, 13.5f);
        mPath.rLineTo(0f, 7.17f);
        mPath.cubicTo(7.0f, 21.4f, 7.6f, 22.0f, 8.33f, 22.0f);
        mPath.rLineTo(7.33f, 0f);
        mPath.rCubicTo(0.74f, 0.0f, 1.34f, -0.6f, 1.34f, -1.33f);
        mPath.lineTo(17.0f, 13.5f);
        mPath.rLineTo(-2.53f, 0f);
        mPath.close();
        mPath.moveTo(14.47f, 13.5f);
