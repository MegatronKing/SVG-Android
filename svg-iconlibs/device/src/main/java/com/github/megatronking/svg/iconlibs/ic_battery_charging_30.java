 ...
 */
public class ic_battery_charging_30 extends SVGRenderer {

    public ic_battery_charging_30(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rLineTo(0f, 9.17f);
        mPath.rLineTo(2.0f, 0f);
        mPath.lineTo(13.0f, 7.0f);
        mPath.rLineTo(0f, 5.5f);
        mPath.rLineTo(2.0f, 0f);
        mPath.rLineTo(-1.07f, 2.0f);
        mPath.lineTo(17.0f, 14.5f);
