 ...
 */
public class ic_battery_charging_80 extends SVGRenderer {

    public ic_battery_charging_80(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
