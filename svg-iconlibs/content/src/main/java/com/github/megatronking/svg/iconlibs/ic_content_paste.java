 ...
 */
public class ic_content_paste extends SVGRenderer {

    public ic_content_paste(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.cubicTo(14.4f, 0.84f, 13.3f, 0.0f, 12.0f, 0.0f);
