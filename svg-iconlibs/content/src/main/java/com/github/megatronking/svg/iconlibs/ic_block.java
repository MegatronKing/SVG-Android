 ...
 */
public class ic_block extends SVGRenderer {

    public ic_block(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rCubicTo(1.85f, 0.0f, 3.55f, 0.63f, 4.9f, 1.69f);
        mPath.lineTo(5.69f, 16.9f);
        mPath.cubicTo(4.63f, 15.55f, 4.0f, 13.85f, 4.0f, 12.0f);
        mPath.close();
        mPath.moveTo(4.0f, 12.0f);
        mPath.rMoveTo(8.0f, 8.0f);
        mPath.rCubicTo(-1.85f, 0.0f, -3.55f, -0.63f, -4.9f, -1.69f);
        mPath.lineTo(18.31f, 7.1f);
        mPath.cubicTo(19.37f, 8.45f, 20.0f, 10.15f, 20.0f, 12.0f);
        mPath.rCubicTo(0.0f, 4.42f, -3.58f, 8.0f, -8.0f, 8.0f);
        mPath.close();
