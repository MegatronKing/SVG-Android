 ...
 */
public class ic_forward_10 extends SVGRenderer {

    public ic_forward_10(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
