 ...
 */
public class ic_subscriptions extends SVGRenderer {

    public ic_subscriptions(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rLineTo(-6.0f, -3.27f);
        mPath.rLineTo(0f, 6.53f);
