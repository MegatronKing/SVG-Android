 ...
 */
public class ic_queue_music extends SVGRenderer {

    public ic_queue_music(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rLineTo(0f, 8.18f);
        mPath.rCubicTo(-0.31f, -0.11f, -0.65f, -0.18f, -1.0f, -0.18f);
