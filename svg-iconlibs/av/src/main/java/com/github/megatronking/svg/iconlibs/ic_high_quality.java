 ...
 */
public class ic_high_quality extends SVGRenderer {

    public ic_high_quality(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rMoveTo(7.0f, -1.0f);
        mPath.rCubicTo(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        mPath.rLineTo(-0.75f, 0f);
        mPath.rLineTo(0f, 1.5f);
        mPath.rLineTo(-1.5f, 0f);
        mPath.lineTo(14.75f, 15.0f);
