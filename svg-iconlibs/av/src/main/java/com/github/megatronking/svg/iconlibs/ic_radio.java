 ...
 */
public class ic_radio extends SVGRenderer {

    public ic_radio(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.moveTo(3.24f, 6.15f);
        mPath.cubicTo(2.51f, 6.43f, 2.0f, 7.17f, 2.0f, 8.0f);
        ...
        mPath.lineTo(8.3f, 6.0f);
        mPath.rLineTo(8.26f, -3.34f);
        mPath.lineTo(15.88f, 1.0f);
        mPath.lineTo(3.24f, 6.15f);
        mPath.close();
        mPath.moveTo(3.24f, 6.15f);
