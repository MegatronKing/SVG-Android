 ...
 */
public class ic_music_video extends SVGRenderer {

    public ic_music_video(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.moveTo(8.0f, 15.0f);
        mPath.rCubicTo(0.0f, -1.66f, 1.34f, -3.0f, 3.0f, -3.0f);
        mPath.rCubicTo(0.35f, 0.0f, 0.69f, 0.07f, 1.0f, 0.18f);
        mPath.lineTo(12.0f, 6.0f);
        mPath.rLineTo(5.0f, 0f);
        mPath.rLineTo(0f, 2.0f);
        mPath.rLineTo(-3.0f, 0f);
        mPath.rLineTo(0f, 7.03f);
        mPath.rCubicTo(-0.02f, 1.64f, -1.35f, 2.97f, -3.0f, 2.97f);
