 ...
 */
public class ic_picture_as_pdf extends SVGRenderer {

    public ic_picture_as_pdf(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
