 ...
 */
public class ic_vignette extends SVGRenderer {

    public ic_vignette(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rCubicTo(-4.42f, 0.0f, -8.0f, -2.69f, -8.0f, -6.0f);
        mPath.rCubicTo(0.0f, -3.3099995f, 3.58f, -6.0f, 8.0f, -6.0f);
        mPath.rCubicTo(4.42f, 0.0f, 8.0f, 2.69f, 8.0f, 6.0f);
        mPath.rCubicTo(0.0f, 3.3099995f, -3.58f, 6.0f, -8.0f, 6.0f);
        mPath.close();
