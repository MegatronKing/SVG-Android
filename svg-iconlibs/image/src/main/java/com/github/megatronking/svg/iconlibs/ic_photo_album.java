 ...
 */
public class ic_photo_album extends SVGRenderer {

    public ic_photo_album(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
