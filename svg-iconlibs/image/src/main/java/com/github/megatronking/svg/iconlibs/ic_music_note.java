 ...
 */
public class ic_music_note extends SVGRenderer {

    public ic_music_note(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rLineTo(0f, 10.55f);
        mPath.rCubicTo(-0.59f, -0.34f, -1.27f, -0.55f, -2.0f, -0.55f);
