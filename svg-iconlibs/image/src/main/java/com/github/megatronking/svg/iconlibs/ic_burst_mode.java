 ...
 */
public class ic_burst_mode extends SVGRenderer {

    public ic_burst_mode(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rCubicTo(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        mPath.close();
        mPath.moveTo(22.0f, 5.0f);
        mPath.moveTo(11.0f, 17.0f);
        mPath.rLineTo(2.5f, -3.15f);
        mPath.lineTo(15.29f, 16.0f);
        mPath.rLineTo(2.5f, -3.22f);
        mPath.lineTo(21.0f, 17.0f);
