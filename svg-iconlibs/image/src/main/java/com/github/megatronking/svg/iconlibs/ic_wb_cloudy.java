 ...
 */
public class ic_wb_cloudy extends SVGRenderer {

    public ic_wb_cloudy(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rCubicTo(0.0f, -2.64f, -2.05f, -4.78f, -4.64f, -4.96f);
        mPath.close();
        mPath.moveTo(19.36f, 10.04f);
