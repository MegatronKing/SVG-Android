 ...
 */
public class ic_photo_size_select_small extends SVGRenderer {

    public ic_photo_size_select_small(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
