 ...
 */
public class ic_add_a_photo extends SVGRenderer {

    public ic_add_a_photo(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.moveTo(3.0f, 4.0f);
        mPath.lineTo(3.0f, 1.0f);
        ...
        mPath.rMoveTo(-3.2f, -5.0f);
        mPath.rCubicTo(0.0f, 1.77f, 1.43f, 3.2f, 3.2f, 3.2f);
        mPath.rCubicTo(1.7699995f, 0.0f, 3.2f, -1.43f, 3.2f, -3.2f);
        mPath.rCubicTo(0.0f, -1.7699995f, -1.43f, -3.2f, -3.2f, -3.2f);
        mPath.rCubicTo(-1.7699995f, 0.0f, -3.2f, 1.43f, -3.2f, 3.2f);
        mPath.close();
        mPath.moveTo(9.8f, 14.0f);
