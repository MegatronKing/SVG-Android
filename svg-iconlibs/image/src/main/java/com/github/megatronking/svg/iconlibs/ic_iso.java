 ...
 */
public class ic_iso extends SVGRenderer {

    public ic_iso(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.close();
        mPath.moveTo(19.0f, 3.0f);
        mPath.moveTo(5.5f, 7.5f);
        mPath.rLineTo(2.0f, 0f);
        mPath.rLineTo(0f, -2.0f);
        mPath.lineTo(9.0f, 5.5f);
        mPath.rLineTo(0f, 2.0f);
        mPath.rLineTo(2.0f, 0f);
        mPath.lineTo(11.0f, 9.0f);
        mPath.lineTo(9.0f, 9.0f);
        mPath.rLineTo(0f, 2.0f);
        mPath.lineTo(7.5f, 11.0f);
        mPath.lineTo(7.5f, 9.0f);
        mPath.rLineTo(-2.0f, 0f);
        mPath.lineTo(5.5f, 7.5f);
        mPath.close();
        mPath.moveTo(5.5f, 7.5f);
