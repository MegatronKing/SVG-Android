 ...
 */
public class ic_switch_video extends SVGRenderer {

    public ic_switch_video(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.lineTo(3.5f, 12.0f);
        mPath.lineTo(7.0f, 8.5f);
        mPath.lineTo(7.0f, 11.0f);
        mPath.rLineTo(6.0f, 0f);
        mPath.lineTo(13.0f, 8.5f);
        mPath.rLineTo(3.5f, 3.5f);
        mPath.rLineTo(-3.5f, 3.5f);
        mPath.close();
        mPath.moveTo(13.0f, 15.5f);
