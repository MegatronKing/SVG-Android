 ...
 */
public class ic_view_comfy extends SVGRenderer {

    public ic_view_comfy(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.close();
        mPath.moveTo(8.0f, 9.0f);
        mPath.rMoveTo(5.0f, -4.0f);
        mPath.rLineTo(0f, 4.0f);
        mPath.rLineTo(4.0f, 0f);
        mPath.lineTo(17.0f, 5.0f);
        mPath.rLineTo(-4.0f, 0f);
        mPath.close();
        mPath.moveTo(13.0f, 5.0f);
