 ...
 */
public class ic_crop_original extends SVGRenderer {

    public ic_crop_original(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(24.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rMoveTo(-5.04f, -6.71f);
        mPath.rLineTo(-2.75f, 3.54f);
        mPath.rLineTo(-1.96f, -2.36f);
        mPath.lineTo(6.5f, 17.0f);
        mPath.rLineTo(11.0f, 0f);
        mPath.rLineTo(-3.54f, -4.71f);
        mPath.close();
        mPath.moveTo(13.96f, 12.29f);
